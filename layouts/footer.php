                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6" style="color:black;">
                                <script>document.write(new Date().getFullYear())</script> POWERED BY IT © MPI  
                            </div>
                            <div class="col-md-6">
        ...
        <script src="assets/js/pages/apex-pie.js"></script>
        <script src="assets/js/pages/apex-column.js"></script>
        <!-- end demo js-->
    </body>
</html>